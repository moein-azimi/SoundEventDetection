...
path = 'C:/UCC/DataBase/noise-of-life-master/'
path2 = 'C:/UCC/codes/eventdetection/spectrograms/'
path3 = 'C:/UCC/codes/eventdetection/Xception-spect/'
path4 = 'C:/UCC/codes/eventdetection/resnet50-spect/'
x = os.listdir(path)
#print(x)
...
for i in range(0,len(x)):
    if x[i].endswith('wav'):
        ...
        try:
            ...
            plt.savefig(path4+'/'+x[i]+'.png',dpi=400,bbox_inches='tight',pad_inches=0)
            plt.close('all')
        except:
            print('failed',x[i])
